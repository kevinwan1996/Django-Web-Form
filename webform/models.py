...
class LifeCycle(models.Model):
	...
	target_approval_date = models.CharField(blank=True, help_text='Enter all dates in format MM/DD/YYYY', max_length=10)
	target_development_date = models.CharField(blank=True, max_length=10)
	target_R1 = models.CharField(blank=True, max_length=10)
	target_R2 = models.CharField(blank=True, max_length=10)
	target_go_live = models.CharField(blank=True, max_length=10)
	target_R3 = models.CharField(blank=True, max_length=10)
	ivv_id = models.CharField(max_length=10)
...
class Recommendations(models.Model):
	...
	recommendation_date = models.CharField(max_length=10)
...
class IVV(models.Model):
	...
	progress_report_date = models.CharField(max_length=10)
	activity_one_consult_date = models.CharField(max_length=10)
	target_RFP_release_date = models.CharField(max_length=10)
	next_progress_report_date = models.CharField(max_length=10)
	target_IVV_on_board_date = models.CharField(max_length=10)
